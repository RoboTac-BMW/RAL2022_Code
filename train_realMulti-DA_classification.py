...
def parse_args():
    ...
    parser.add_argument('--alpha', type=float, default=1, help='set the value of classification loss')
    parser.add_argument('--lamda', type=float, default=1, help='set the value of CORAL loss')
    parser.add_argument('--beta', type=float, default=1, help='set the value of MMD loss')
