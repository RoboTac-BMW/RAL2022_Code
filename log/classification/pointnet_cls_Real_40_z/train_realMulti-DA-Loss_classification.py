...
def parse_args():
    ...
    parser.add_argument('--lamda', type=float, default=5, help='set the value of CORAL loss')
    parser.add_argument('--beta', type=float, default=5, help='set the value of MMD loss')
